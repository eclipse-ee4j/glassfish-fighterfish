 ...
 * {@link HttpServletRequest#getSession(boolean)#getServletContext()} to retrieve the ServletContext and from there it
 * reads the attribute values to demonstrate that it does not mater how you retrieve the ServletContext, they are all
